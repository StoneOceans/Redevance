                                        ...
                                        <div class="modal-body">
                                            <form method="post" action="{{ route('vol_allft.update', $vol->id) }}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control @error('heure_de_reference') is-invalid @enderror" name="heure_de_reference" value="{{ old('heure_de_reference', $vol->heure_de_reference) }}" />
                                                    @error('heure_de_reference')
...
document.addEventListener('DOMContentLoaded', function () {
    @if($errors->any())
        var editModal = new bootstrap.Modal(document.getElementById('editModal{{ $vol->id }}'));
        editModal.show();
    @endif
});
</script>
